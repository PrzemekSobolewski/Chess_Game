    ...
    public Collection<Move> calculateLegalMoves(Board board) {
        ...
        for (final int currentCoordinateOffset : CANDIDATE_MOVE_COORDINATES) {
            ...
            if (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                ...
                if (isFirstColumnExlusion(this.piecePosition, currentCoordinateOffset) || isSecondColumnExlusion(this.piecePosition, currentCoordinateOffset) || isSeventhColumnExlusion(this.piecePosition, currentCoordinateOffset) || isEightColumnExlusion(this.piecePosition, currentCoordinateOffset)) {
                    continue;
                }
