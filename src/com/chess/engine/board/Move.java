...
public abstract class Move {
    ...
    public static final class PawnOnPassantAttackMove extends PawnAttackMove {
        public PawnOnPassantAttackMove(final Board board, final Piece movedPiece, final int destinationCoordinate, final Piece attackedPiece) {
            super(board, movedPiece, destinationCoordinate, attackedPiece);
        }
        @Override
        public boolean equals(final Object other) {
            return this == other || other instanceof PawnOnPassantAttackMove&& super.equals(other);
