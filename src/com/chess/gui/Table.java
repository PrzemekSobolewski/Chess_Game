...
public class Table {
    ...
    private final static Dimension BOARD_PANEL_DEMENSION = new Dimension(400, 350);
    private static String defaultPieceImagesPath = "chess gifs/";
    ...
    public Table() {
        ...
        this.chessBoard = Board.createStadardBoard();
